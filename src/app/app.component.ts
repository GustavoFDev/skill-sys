...
export class AppComponent implements AfterViewInit, OnInit {
  ...
  private hiddenRoutes: string[] = ['login', 'creencias_personales1', 'applicant', 'creencias_personales2', 'creencias_personales3', 'creencias_personales4', 'razonamiento_numerico', 'escenarios_realistas', 'razonamiento_logico' ];
